...
def test_fadvi():
    ...
    assert latent_full.shape[0] == adata.n_obs, "Full latent representation has wrong number of cells"
    assert latent_b.shape[0] == adata.n_obs, "Batch latent representation has wrong number of cells" 
    assert latent_l.shape[0] == adata.n_obs, "Label latent representation has wrong number of cells"
    assert latent_r.shape[0] == adata.n_obs, "Residual latent representation has wrong number of cells"
